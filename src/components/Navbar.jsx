            ...
            <div className="flex items-center gap-4">
              ...
              <div className="relative group z-50">
                <button className="flex items-center gap-2 py-2 focus:outline-none">
                  ...
                  <ChevronDown
                    size={14}
                    className="text-slate-400 group-hover:text-primary transition-transform group-hover:rotate-180"
                  />
                </button>
          ...
          <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-transparent dark:bg-gray-800 md:dark:bg-transparent dark:border-gray-700">
            ...
            <li>
              <div className="relative group">
                <button
                  className={`flex items-center py-2 px-3 rounded md:p-0 transition-all duration-300 ${isActive("/shop")}`}
                >
                ...
                <div className="absolute z-10 hidden font-normal bg-white divide-y divide-gray-100 rounded-lg shadow-xl w-64 group-hover:block animate-fade-in-down top-full left-0 border border-gray-100">
                  <ul className="py-2 text-sm text-gray-700">
                    <li>
                      <Link
                        to="/shop"
                        className="block px-4 py-2 hover:bg-slate-50 font-bold text-primary"
                      >
                        Shop All
                      </Link>
                    </li>
                    {categories
                      ...
                      .map((parent) => (
                        <li
                          key={parent._id}
                          className="relative group/sub px-4 py-2 hover:bg-slate-50 cursor-pointer"
                        >
                          <div className="flex justify-between items-center w-full">
                            ...
                            <ChevronDown
                              size={14}
                              className="-rotate-90 text-gray-400 group-hover/sub:text-primary"
                            />
                          </div>
                                  ...
                                  .map((sub) => (
                                    <li key={sub._id}>
                                      <Link
                                        ...
                                        className="block px-4 py-2 hover:bg-slate-50 text-slate-600 hover:text-primary"
                                      >
                                        {sub.name}
                                      </Link>
                                    </li>
